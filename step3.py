...
def save_text_output(result, output_path):
    """
    Transkripsiyon sonucunu timestamp'li metin olarak kaydet
    ...
    # TXT dosyası olarak kaydet (timestamp'li)
    ...
    # İlk 3 segmenti göster
    print(f"\n📄 Önizleme (İlk 3 segment):")
    print("-" * 70)
...
def format_timestamp(seconds):
    ...
    Args:
        seconds: Saniye (float)

    Returns:
        Formatlanmış zaman (str)
    """
